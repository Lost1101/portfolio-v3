    ...
    return(
        <div className="h-screen mx-20">
            <div className="align-middle pt-24">
                <div>
                  <Text type="h4" className="text-lg text-center mb-10">
                    Here's a list of my technical skills and tools I frequently use.
                    </Text>
                </div>
                <div className="flex justify-center gap-10 ">
                    <Card title={'Front-End'} className="mb-10 w-1/4">
                        ...
                        <div className="p-4">
                            <Text type="p" className="text-sm text-justify">In software development, front-end refers to the part of a website or application that users interact with directly. <sup><a className="text-accent" href="https://en.wikipedia.org/wiki/Front_end_and_back_end">[1]</a></sup></Text>
                        </div>
                    </Card>
                    <Card title={'Back-End'} className="mb-10 w-1/4">
                        <div className="justify-items-center grid grid-cols-3">
                        ...
                        <div className="p-4">
                            <Text type="p" className="text-sm text-justify">In software development, back-end refers to the data management and processing behind the scenes. <sup><a className="text-accent" href="https://en.wikipedia.org/wiki/Front_end_and_back_end">[1]</a></sup></Text>
                        </div>
                    </Card>
                    <Card title={'Misc'} className="mb-10 w-1/4">
                        <div className="justify-items-center grid grid-cols-3">
                        ...
                        <div className="p-4">
                            <Text type="p" className="text-sm text-justify">Supportive tools to help my workflow and enhance productivity.</Text>
                        </div>
                    </Card>
                </div>
            </div>
